...
### Output
- `.agents/mkt/lp-brief/pricing/brief.md` (412 lines)
- `.agents/mkt/lp-brief/pricing/handoff-claude-design.md`
- `.agents/mkt/lp-brief/pricing/handoff-designer.md`
- `.agents/mkt/lp-brief/pricing/asset-slots/hero-receipt.prompt.md`
- `.agents/mkt/lp-brief/pricing/asset-slots/og-image.prompt.md`
- Status: **DONE**
...
### Output
- `.agents/mkt/lp-brief/pricing/v2/brief.md` (438 lines)
...
### Output
- `.agents/mkt/lp-brief/pricing/v3/brief.md` (522 lines)
