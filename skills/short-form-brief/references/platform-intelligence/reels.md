...
| 2026-05-08 | Phase 0.5b URL repair (Bucket A + B). Finding 7 closed: Archetype 1 examples A+B (DM-Trigger Hook patterns) relabeled `[pattern-observed; URL not pinned]`; specific @vanessalau.co / @stephanie.kase post URLs not pinned. Finding 8 closed: removed `[S13]` mis-attribution from the Stephanie Kase example (S13 is the ManyChat Comments-trigger doc — the automation tool, not Stephanie Kase's verbatim text). `last_verified` bumped to 2026-05-08. | assistant-2026-05-08 |
