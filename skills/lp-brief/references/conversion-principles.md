...
- **Conversion-critic agent:** the rubric in `agents/conversion-critic-agent.md` references these IDs. Each FAIL must cite the principle ID and the offending brief line.
- **Citation format in critic output:** `[CP-04 — 5-Field Form Maximum] Form spec lists 7 fields with no exception justification.`
...
- **Source:** `core-principles.md` lines 3–37
...
- **Source:** `core-principles.md` lines 41–72
...
- **Source:** `core-principles.md` lines 76–103
...
- **Source:** `core-principles.md` lines 144–176
...
- **Source:** `core-principles.md` lines 180–212
...
- **Source:** `core-principles.md` lines 216–231
...
- **Source:** `core-principles.md` lines 234–258
...
- **Source:** `social-proof-trust.md` lines 3–58
...
- **Source:** `social-proof-trust.md` lines 59–111
...
- **Source:** `implementation-checklist.md` lines 3–60
...
- **Source:** `implementation-checklist.md` lines 175–180
