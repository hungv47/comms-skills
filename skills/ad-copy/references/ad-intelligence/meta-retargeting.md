...
Per-surface reference for the **Meta retargeting** ad layer. Will be consumed by the future `ad-copy` skill (not yet scaffolded — see `skills-resources/meta/roadmap.md` REB-3). Until then: practitioner-grade source-of-truth for retargeting setup, warm-creative differentiation, and budget pacing.
