...
- Sibling coordination: lp-brief (`marketing-skills/skills/lp-brief/`) for construction-time architecture; eval-loop (`meta-skills/skills/eval-loop/`) for loop scaffolding + durable learning ledger.
