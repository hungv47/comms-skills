...
| **content_artifact** | markdown \| null | `skills-resources/marketing/content/[slug].md` if a relevant copy artifact exists |
...
- **Pull from content artifact first** — if `skills-resources/marketing/content/[slug].copy.md` exists with a hook/CTA already, use those. Don't second-guess copywriting's craft.
